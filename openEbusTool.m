...
script6 = fullfile(scriptsDir, 'eBus_Plot_Comparison.m');
...
localPrintScriptLink( ...
    ...
    'Create DIVe Dataset Variant folders by editing or/and adding variables');
localPrintScriptLink( ...
    'DIVe_sMP_Compare', ...
    script5, ...
    'matlab:DIVe_sMP_Compare', ...
    'sMP parameter comparisons of DIVe Simulation.');
localPrintScriptLink( ...
    'eBus_Plot_Comparison', ...
    script6, ...
    'matlab:eBus_Plot_Comparison', ...
    'To compare the plots of two simulation or measurement files.');
