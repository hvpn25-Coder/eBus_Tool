...
switch normalized
    ...
    case "ELECTRICDRIVEUNIT"
        aliases = [aliases, "ELECTRICDRIVEUNIT", "EDU", "EDRIVEUNIT", ...
            "ELECTRICDRIVE", "EDRIVE", "MOTORDRIVE", "TRANSMISSION", ...
            "GEARBOX", "FINALDRIVE", "DIFF", "AXLEDRIVE", ...
            "ANALYZEELECTRICDRIVEUNIT", "ANALYZEELECTRICDRIVE", ...
            "ANALYZETRANSMISSION", "ANALYZEFINALDRIVE"];
    case "ELECTRICDRIVE"
        aliases = [aliases, "ELECTRICDRIVEUNIT", "EDU", "ELECTRICDRIVE", ...
            "EDRIVE", "MOTORDRIVE", "ANALYZEELECTRICDRIVEUNIT", ...
            "ANALYZEELECTRICDRIVE"];
    case "TRANSMISSION"
        aliases = [aliases, "ELECTRICDRIVEUNIT", "EDU", "TRANSMISSION", ...
            "GEARBOX", "ANALYZEELECTRICDRIVEUNIT", "ANALYZETRANSMISSION"];
    case "FINALDRIVE"
        aliases = [aliases, "ELECTRICDRIVEUNIT", "EDU", "FINALDRIVE", ...
            "DIFF", "AXLEDRIVE", "ANALYZEELECTRICDRIVEUNIT", "ANALYZEFINALDRIVE"];
    ...
    case "VEHICLEDYNAMICS"
        aliases = [aliases, "VEHICLEDYNAMICS", "VDY", "VEHDYN", "ANALYZEVEHICLEDYNAMICS"];
    case "BATTERY"
