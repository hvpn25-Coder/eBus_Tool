...
localAddHeading(selection, '9.4 Important Assumptions', 2);
localWriteStringList(selection, '', [ ...
...
localAddHeading(selection, '9.5 Data Quality Checks Performed', 2);
localWriteStringList(selection, '', [ ...
...
localAddHeading(selection, '9.6 Known Data Limitations', 2);
...
keys = { ...
    ...
    '9.3 Data Sources', '9.4 Important Assumptions', '9.5 Data Quality Checks Performed', ...
    '9.6 Known Data Limitations', '10. Analysis Methodology', '10.1 Overall RCA Workflow', ...
...
values = { ...
    ...
    '7. Abkuerzungen / Nomenklatur', '8. Einleitung', ...
    ...
    '9. Simulations- und Datenuebersicht', '9.1 Modelluebersicht', '9.2 Analysierte Simulationsfaelle / Fahrzyklen / Szenarien', ...
    '9.3 Datenquellen', '9.4 Wichtige Annahmen', '9.5 Durchgefuehrte Datenqualitaetspruefungen', ...
    '9.6 Bekannte Datenbeschraenkungen', '10. Analysemethodik', '10.1 Gesamter RCA-Workflow', ...
