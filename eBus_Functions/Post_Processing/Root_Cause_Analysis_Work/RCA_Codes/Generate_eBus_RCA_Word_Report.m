...
rows = { ...
    ...
    'For each shortlisted segment, compute normalized scores for slope load, auxiliary load, low SoC, battery limit use, gear operation, rolling resistance, aero drag, controller tracking, motor/inverter losses, transmission losses, and regen miss.', ...
...
if height(reportData.SegmentSummary) > 0
    ...
    scoreExpression = ['For each shortlisted segment, RCA computes weighted normalized scores for: ', ...
        ...
        'ControllerTracking, MotorInverter, TransmissionLoss, and RegenMiss.'];
...
rows = { ...
    ...
    'For each shortlisted segment, compute weighted normalized scores for SlopeLoad, AuxiliaryLoad, LowSOC, BatteryLimit, GearOperation, RollingResistance, AeroDrag, ControllerTracking, MotorInverter, TransmissionLoss, and RegenMiss.', ...
