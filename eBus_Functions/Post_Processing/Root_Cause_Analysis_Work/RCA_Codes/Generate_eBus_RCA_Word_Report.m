...
rows = { ...
    ...
    '3. Fallback worst-segment selection', 'EfficiencySeverity and PerformanceSeverity', ...
    ...
    '4. Cause scoring', 'Candidate segment KPI rows', ...
    ...
    '5. Bad-segment summary build', 'Top-ranked cause and contribution', ...
    'Store the segment issue type, primary cause, primary contribution, confidence, evidence signals, and narrative in the bad-segment table.', ...
...
if height(reportData.SegmentSummary) > 0
    ...
    rows = { ...
        ...
        '3. Fallback worst-severity ranking', sprintf('EfficiencySeverity = %s | PerformanceSeverity = %s', ...
        ...
        '4. Performance check', sprintf('Tracking MAE = %s km/h | Torque tracking MAE = %s Nm', ...
        ...
        '5. Loss check', sprintf('Loss share = %s %%', localSafeValueText(segRow, 'LossShare_pct', '%.1f')), ...
        ...
        '6. Bad-segment shortlist decision', sprintf('Primary issue tag = %s', localSafeStringText(segRow, 'PrimaryIssueTag')), ...
        ...
        '7. Root-cause score build', 'Normalized weighted factor score vector for all configured causes', ...
        scoreExpression, ...
        sprintf('Top ranked causes after score calculation: %s', topCauseNames); ...
        '8. Root-cause ranking', 'All cause scores are sorted in descending order', ...
        ...
        '9. Primary cause selection', sprintf('PrimaryCause = %s', localExtractPrimaryCauseText(segRow, reportData.BadSegmentTable, rankingRows)), ...
        ...
        '10. Contribution percentage calculation', sprintf('Primary contribution = %s %%', localExtractPrimaryContributionText(segRow, reportData.BadSegmentTable, rankingRows)), ...
        ...
        '11. Confidence assignment', sprintf('Confidence = %s', localExtractConfidenceText(segRow, reportData.BadSegmentTable, rankingRows)), ...
...
if isempty(rows)
    rows = { ...
        ...
        '3. Fallback worst-severity ranking', '[Insert severity metrics]', 'Rank segments by max(EfficiencySeverity, PerformanceSeverity) if no explicit bad flags exist.', '[Insert result]'; ...
        '4. Performance check', '[Insert tracking metrics]', sprintf('Compare against poor-tracking basis (%s).', localThresholdValueText(reportData, 'PoorTrackingError_kmh')), '[Insert result]'; ...
        '5. Loss check', '[Insert loss share]', sprintf('Compare against high-loss threshold (%s).', localThresholdValueText(reportData, 'HighLossShare_pct')), '[Insert result]'; ...
        '6. Shortlist decision', '[Insert combined status]', 'If any bad flag is true, the segment enters the bad-segment shortlist.', '[Insert result]'; ...
        '7. Root-cause score build', '[Insert factor score vector]', 'Compute weighted normalized cause scores for all configured factors.', '[Insert result]'; ...
        '8. Root-cause ranking', '[Insert sorted causes]', 'Sort cause scores descending to build CauseRank 1, 2, 3, ...', '[Insert result]'; ...
        '9. Primary cause selection', '[Insert primary cause]', 'Choose the cause with rank 1.', '[Insert result]'; ...
        '10. Contribution percentage calculation', '[Insert score and total score]', 'Compute 100 x factorScore / sum(all factorScores).', '[Insert result]'; ...
        '11. Confidence assignment', '[Insert active-factor count]', '>= 6 High, >= 3 Medium, else Low.', '[Insert result]'; ...
        '12. Final bad-segment record', '[Insert issue and primary cause]', 'Store ranked RCA outcome into the bad-segment table.', '[Insert result]'};
end
end
